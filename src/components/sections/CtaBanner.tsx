...
export default function CtaBanner() {
  return (
    <section className="py-24 relative overflow-hidden">
      {/* Background with full cable gradient (pastel via opacity) */}
      <div className="absolute inset-0 bg-kh-full opacity-[0.08] z-0"></div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <button className="bg-kh-dark text-white px-8 py-4 rounded-full font-bold text-lg flex items-center justify-center gap-2 mx-auto shadow-card hover:shadow-cool-md hover:bg-kh-purple hover:-translate-y-1 transition-all duration-300 group">
          Book a Demo
